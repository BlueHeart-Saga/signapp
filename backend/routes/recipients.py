...
def serialize_recipient(recipient):
    ...
    return {
        ...
        "added_at": recipient.get("added_at", datetime.utcnow()).isoformat() + "Z",
        "sent_at": recipient.get("sent_at").isoformat() + "Z" if recipient.get("sent_at") else None,
        "signed_at": recipient.get("signed_at").isoformat() + "Z" if recipient.get("signed_at") else None,
        "approved_at": recipient.get("approved_at").isoformat() + "Z" if recipient.get("approved_at") else None,
        "form_completed_at": recipient.get("form_completed_at").isoformat() + "Z" if recipient.get("form_completed_at") else None,
        "witnessed_at": recipient.get("witnessed_at").isoformat() + "Z" if recipient.get("witnessed_at") else None,
