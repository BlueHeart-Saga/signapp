...
//     //  IMPORTANT: Convert from PDF bottom-left to screen top-left
...
//         //  IMPORTANT: High z-index to sit above PDF canvas
//         zIndex: 200,
...
//   if (!pageDimensions) {
//     console.warn(` Overlay NOT rendered (no pageDimensions) → Page ${pageNum}`);
//     return null;
//   }

//   if (pageFields.length === 0) {
//     console.warn(` Overlay NOT rendered (no fields) → Page ${pageNum}`);
//     return null;
//   }

//   if (mode !== 'edit') {
//     console.warn(` Overlay NOT rendered (mode=${mode}) → Page ${pageNum}`);
//     return null;
//   }
...
//         width: '100%',
//         height: '100%',
//         //  IMPORTANT: Container has no pointer events, children control their own
//         pointerEvents: 'none',
