...
const SigningPage = () => {
  ...
  const loadData = async () => {
    try {
      ...
      // 🔐 SECURITY CHECK: Prevent OTP/Terms bypass via manual URL entry
      const signingInfo = recipientData.signing_info;
      if (signingInfo) {
        // If OTP or Terms are required, redirect back to verification page
        ...
        // Handle terminal document/recipient states
        if (signingInfo.terms_status === 'declined') {
