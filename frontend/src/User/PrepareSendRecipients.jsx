...
>
  ...
  <img
    src={`${API_BASE_URL}${file.thumbnail_url}?token=${token}`}
    alt={file.filename}
  />
</div>
...
>
  ...
  {form.personal_message && (
    ...
    shakingRow === index ? "docusign-btn-error" : ""
  }`}
...
<div
  className={`docusign-message-row ${
    openMessageIndex === index ? 'docusign-message-open' : ''
  }`}
>
  <div className="docusign-inline-field docusign-full-width">
